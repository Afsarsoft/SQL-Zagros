...
WHERE SPECIFIC_SCHEMA = N'Zagros'
    AND SPECIFIC_NAME = N'UpdatePackage'
    AND ROUTINE_TYPE = N'PROCEDURE'
)
DROP PROCEDURE Zagros.UpdatePackage
GO
CREATE PROCEDURE Zagros.UpdatePackage
    @PackageID TINYINT,
...
----------------------------------------------------------------------------------------------------
Procedure:      Zagros.UpdatePackage
Create Date:    2020-09-01 (yyyy-mm-dd)
Author:         Surush Cyrus
Description:    Updatre a Package
Call by:        UI, Add hoc

Steps:          1- Check the @PackageID for RI issue in Zagros.Package table
                2- Update table Zagros.Package
...
Usage:          EXEC Zagros.UpdatePackage @PackageID = 25,
