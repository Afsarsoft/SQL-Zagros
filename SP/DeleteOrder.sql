...
WHERE SPECIFIC_SCHEMA = N'Zagros'
    AND SPECIFIC_NAME = N'DeleteOrder'
    AND ROUTINE_TYPE = N'PROCEDURE'
)
DROP PROCEDURE Zagros.DeleteOrder
GO
CREATE PROCEDURE Zagros.DeleteOrder
    @OrderID INT
AS
/***************************************************************************************************
File: DeleteCustomer.sql
----------------------------------------------------------------------------------------------------
Procedure:      Zagros.DeleteLocation
...
Usage:          Zagros.DeleteLocation 19
****************************************************************************************************
SUMMARY OF CHANGES
...
SET @Message = 'Completed DELETE from OrderDetail table for OrderID = ' + CONVERT(VARCHAR(10), @OrderID) ;   
RAISERROR(@Message, 0,1) WITH NOWAIT;
EXEC Zagros.InsertHistory @SP = @SP,
   @Status = 'Run',
   @Message = @Message
