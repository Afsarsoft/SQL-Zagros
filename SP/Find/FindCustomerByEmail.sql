...
WHERE SPECIFIC_SCHEMA = N'Zagros'
   AND SPECIFIC_NAME = N'FindCustomerByEmail'
   AND ROUTINE_TYPE = N'PROCEDURE'
)
DROP PROCEDURE Zagros.FindCustomerByEmail
GO
CREATE PROCEDURE Zagros.FindCustomerByEmail
   @Email NVARCHAR(50)
AS
/***************************************************************************************************
File: FindCustomerByEmail.sql
----------------------------------------------------------------------------------------------------
Procedure:      Zagros.FindCustomerByEmail
...
Steps:          N/A
Parameter(s):   @Email
Usage:          Zagros.FindCustomerByEmail '100001001@xyz.com'
****************************************************************************************************
SUMMARY OF CHANGES
