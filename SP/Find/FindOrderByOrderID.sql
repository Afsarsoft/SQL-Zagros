...
WHERE SPECIFIC_SCHEMA = N'Zagros'
    AND SPECIFIC_NAME = N'FindOrderByOrderID'
    AND ROUTINE_TYPE = N'PROCEDURE'
)
DROP PROCEDURE Zagros.FindOrderByOrderID
GO
CREATE PROCEDURE Zagros.FindOrderByOrderID
    @OrderID INT
AS
/***************************************************************************************************
File: FindOrderByOrderID.sql
----------------------------------------------------------------------------------------------------
Procedure:      Zagros.FindOrderByOrderID
...
Steps:          N/A
Parameter(s):   @OrderID
Usage:          Zagros.FindOrderByOrderID 100001001
****************************************************************************************************
SUMMARY OF CHANGES
