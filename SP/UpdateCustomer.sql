...
WHERE SPECIFIC_SCHEMA = N'Zagros'
    AND SPECIFIC_NAME = N'UpdateCustomer'
    AND ROUTINE_TYPE = N'PROCEDURE'
)
DROP PROCEDURE Zagros.UpdateCustomer
GO
CREATE PROCEDURE Zagros.UpdateCustomer
    @CustomerID INT,
...
----------------------------------------------------------------------------------------------------
Procedure:      Zagros.UpdateCustomer
Create Date:    2020-09-01 (yyyy-mm-dd)
Author:         Surush Cyrus
Description:    Update a Customer
Call by:        UI, Add hoc

Steps:          1- Check the @CustomerID for RI issue in Zagros.Customer table
                2- Update Zagros.Customer table
...
Usage:          EXEC Zagros.UpdateCustomer @CustomerID = 100001052,
                                           @CountryID = 92,
