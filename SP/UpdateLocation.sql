...
WHERE SPECIFIC_SCHEMA = N'Zagros'
   AND SPECIFIC_NAME = N'UpdateLocation'
   AND ROUTINE_TYPE = N'PROCEDURE'
)
DROP PROCEDURE Zagros.UpdateLocation
GO
CREATE PROCEDURE Zagros.UpdateLocation
   @LocationID TINYINT,
...
----------------------------------------------------------------------------------------------------
Procedure:      Zagros.UpdateLocation
Create Date:    2020-09-01 (yyyy-mm-dd)
Author:         Surush Cyrus
Description:    Update a Location
Call by:        UI, Add hoc

Steps:          1- Check the @LocationID for RI issue in Zagros.Location table
                2- Update Zagros.Location table

Parameter(s):   @LocationID
                @Name NULL

Usage:          EXEC Zagros.UpdateLocation @LocationID = 19,
